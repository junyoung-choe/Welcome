package com.welcome.enjoytrip.config;
...
@MapperScan(basePackages = {"com.welcome.enjoytrip.*.model.mapper"})
public class DatabaseConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        session.setTypeAliasesPackage("com.welcome.enjoytrip.*.model");
